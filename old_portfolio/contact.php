...
<body>
	<div id="wrapper">
    	<div id="brandingHolder">
        	<div id="logo">
            	<a href="index.html"><img src="myImages/logo.jpg" title="Julio Ochoa Logo (Coachella California Web Design" border="0" /></a>
            	<p class="hidden">JCO JULIO OCHOA web designer / developer,Julio Ochoa, Coachella valley Web Design , What is Web Design, Coachella California, LA Web Design, Web Design, Web Designer, Graphics Design, JCODesigns, Coachella Web Design.</p>
            </div>   
        </div>
          <ul class="nav current-contact">
         ...
         <hr />
         <p class="hidden">JCO JULIO OCHOA web designer / developer</p>
    ...
    <!-- Start HTML form -->
   	<form name="form" method="post" id="third" action="<?php echo $self;?>"  class="niceform">
		...
		<label for="site">Website : </label>
			<input id="website" name="website" type="text" class="validate['url']" size="30" />
...
?>
             ...
             <div id="contactRight">
             	<h2 class="follow">Come On, Follow Me !</h2>
                         		<ul>
                                	<a href="http://www.twitter.com/julio8a" target="new" class="screenshot" rel="myImages/twitter.jpg"><li><img src="myImages/twitter.png" alt="twitter.com" border="0" /><h4>twitter</h4></li></a>
                                    <a href="http://www.facebook.com/julio8a00" target="new" class="screenshot" rel="myImages/facebook.jpg"><li><img src="myImages/facebook.png" alt="Facebook.com" border="0" /><h4>Facebook</h4></li></a>
                                    <a href="http://www.myspace.com/acousticas" target="new" class="screenshot" rel="myImages/myspace.jpg"><li><img src="myImages/myspace.png" alt="Myspace.com" border="0" /><h4>Myspace</h4></li></a>
                                    <a href="http://www.linkedin.com/pub/julio-ochoa/10/b1b/88" target="new" class="screenshot" rel="myImages/linkedin.jpg"><li><img src="myImages/linkedin.png" alt="linedIn.com" border="0" /><h4>LinkedIn</h4></li></a>
                                    <a href="http://www.flickr.com/photos/jcodesigns" target="new" class="screenshot" rel="myImages/flickr.jpg"><li><img src="myImages/flickr.png" alt="flickr.com" border="0" /><h4>Flickr</h4></li></a>
                                    <a href="http://julio8a00.stumbleupon.com/public/" target="new" class="screenshot" rel="myImages/stumble.jpg"><li><img src="myImages/stumbleupon.png" alt="stumbleupon.com" border="0" /><h4>Stumble</h4></li></a>
                                </ul>
             </div>
         </div>
    </div>
